...
import com.zegames.entities.Coin;
...
public class World {
            ...
            for(int xx = 0; xx < map.getWidth(); xx++){
                for(int yy = 0; yy < map.getHeight(); yy++){
                    ...
                    if(pixelAtual == 0xFF000000) {
                        ...
                        Enemy enemy = new Enemy(xx*16, yy*16, 16, 16, 0.5, Entity.ENEMY1[0]);
                        Game.entities.add(enemy);
                    } else if (pixelAtual == 0xFFFFD800) {
                        Coin coin = new Coin(xx*16, yy*16, 16, 16, 0, Game.spritesheet.getSprite(48, 16, 16, 16));
    ...
    public static void restartGame(){
        ...
        Player.maxCoins = 0;
        Game.player = new Player(0,0,16,16,1.4, Entity.PLAYER_SPRITE_RIGHT[0]);
        Game.entities.clear();
