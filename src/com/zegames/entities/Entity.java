...
public class Entity {
    public static BufferedImage[] PLAYER_SPRITE_RIGHT = {
            ...
            Game.spritesheet.getSprite(31, 48, 16, 16),
    };
    ...
    public static BufferedImage PLAYER_SPRITE_JUMP_RIGHT = Game.spritesheet.getSprite(16, 32, 16, 16);
    public static BufferedImage PLAYER_SPRITE_JUMP_LEFT = Game.spritesheet.getSprite(32, 32, 16, 16);
